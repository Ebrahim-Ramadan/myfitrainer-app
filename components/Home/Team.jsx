...
export const Team = () => {
  ...
  return (
    <>
      ...
      <a href='https://github.com/Ebrahim-Ramadan/myfitrainer-app' className='cursor-pointer hover:bg-slate-200 mb-12 flex flex-row bg-slate-100 [&>*]:h-12 w-full md:w-1/2 p-2 justify-center rounded-full' data-aos="fade-left">
      <Image
          width={50}
