const Plans= () => {
    ...
    const features = [
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="#22D3EE" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#22D3EE" className="w-6 h-6">
        ...
        {
            icon:
            <svg xmlns="http://www.w3.org/2000/svg" fill="#22D3EE" height="16" width="16" viewBox="0 0 512 512" strokeWidth={1.5} stroke="#22D3EE" className="w-6 h-6">
